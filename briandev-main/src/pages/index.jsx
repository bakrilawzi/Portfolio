...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://www.linkedin.com/in/baker-lawzi/" variant="secondary" className="group mt-6 w-full">
               More on LinkedIn 
      ...
      <Container className="mt-9">
        <div className="max-w-2xl text-lg">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Computer Science student, Data Scientist,Backend Developer , and open source enthusiast.
          </h1>
          <p className="mt-6 prose dark:prose-invert">
            I’m Baker, and I am a junior Cs student with a enthusiasm About Data Science . I am newly active  in Open Source &mdash;.
          </p>
          {/* <p className="mt-6 prose dark:prose-invert">
